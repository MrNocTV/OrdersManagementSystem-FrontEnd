...
var fakeCamera2Object = {
    ...
    cameraType: scandit_sdk_1.Camera.Type.FRONT,
    currentResolution: {
        width: 4,
        height: 4
    }
...
ava_1.test.serial("constructor & destroy", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var error, barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, t.throws(scandit_sdk_1.BarcodePicker.create(document.createElement("div")))];
            case 1:
                error = _a.sent();
                t.is(error.name, "UnsupportedBrowserError");
                fakeFullCompatibleBrowser();
                return [4 /*yield*/, t.throws(scandit_sdk_1.BarcodePicker.create(document.createElement("div")))];
            case 2:
                error = _a.sent();
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, t.throws(scandit_sdk_1.BarcodePicker.create(0))];
            case 4:
                error = _a.sent();
                t.is(error.name, "NoOriginElementError");
                return [4 /*yield*/, scandit_sdk_1.BarcodePicker.create(document.createElement("div"), {
                        singleImageMode: {
...
ava_1.test.serial("constructor & destroy (with fake camera)", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var s, barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("isScanningPaused & pauseScanning & resumeScanning (with fake camera)", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var s, barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("accessCamera & getActiveCamera & setActiveCamera (with fake camera)", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 11:
                _a.sent();
                t.deepEqual(barcodePicker.getActiveCamera(), fakeCamera2Object);
                scandit_sdk_1.BrowserHelper.userAgentInfo.setUA("Mozilla/5.0 (Windows NT 10.0; Win64; x64) " +
...
ava_1.test.serial("applyCameraSettings (with fake camera)", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                barcodePicker = _a.sent();
                cs = {
                    resolutionPreference: scandit_sdk_1.CameraSettings.ResolutionPreference.FULL_HD
                };
...
ava_1.test.serial("applyScanSettings", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
ava_1.test.serial("isVisible & setVisible", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("isMirrorImageEnabled & setMirrorImageEnabled", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("isPlaySoundOnScanEnabled & setPlaySoundOnScanEnabled", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("isVibrateOnScanEnabled & setVibrateOnScanEnabled", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("isCameraSwitcherEnabled & setCameraSwitcherEnabled", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("isTorchToggleEnabled & setTorchToggleEnabled", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("isTapToFocusEnabled & setTapToFocusEnabled", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("isPinchToZoomEnabled & setPinchToZoomEnabled", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("setTorchEnabled", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("setZoom", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("setGuiStyle", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                barcodePicker = _a.sent();
                barcodePicker.setGuiStyle(scandit_sdk_1.BarcodePicker.GuiStyle.NONE);
                barcodePicker.setGuiStyle(scandit_sdk_1.BarcodePicker.GuiStyle.LASER);
                barcodePicker.setGuiStyle(scandit_sdk_1.BarcodePicker.GuiStyle.VIEWFINDER);
                barcodePicker.setGuiStyle(scandit_sdk_1.BarcodePicker.GuiStyle.NONE);
                t.pass();
                barcodePicker.destroy();
                return [2 /*return*/];
...
ava_1.test.serial("setVideoFit", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                barcodePicker = _a.sent();
                barcodePicker.setVideoFit(scandit_sdk_1.BarcodePicker.ObjectFit.COVER);
                barcodePicker.setVideoFit(scandit_sdk_1.BarcodePicker.ObjectFit.CONTAIN);
                t.pass();
                barcodePicker.destroy();
                return [2 /*return*/];
        }
...
ava_1.test.serial("createParserForFormat", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                barcodePicker = _a.sent();
                parser = barcodePicker.createParserForFormat(scandit_sdk_1.Parser.DataFormat.DLID);
                t.truthy(parser);
                parser = barcodePicker.createParserForFormat(scandit_sdk_1.Parser.DataFormat.GS1_AI);
                t.truthy(parser);
                parser = barcodePicker.createParserForFormat(scandit_sdk_1.Parser.DataFormat.HIBC);
                t.truthy(parser);
                parser = barcodePicker.createParserForFormat(scandit_sdk_1.Parser.DataFormat.MRTD);
                t.truthy(parser);
                parser = barcodePicker.createParserForFormat(scandit_sdk_1.Parser.DataFormat.SWISSQR);
                t.truthy(parser);
                barcodePicker.destroy();
                return [2 /*return*/];
        }
...
ava_1.test.serial("reassignOriginElement", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, scandit_sdk_1.BarcodePicker.create(element1, {
                        accessCamera: false
                    })];
            case 2:
                barcodePicker = _a.sent();
...
ava_1.test.serial("setTargetScanningFPS", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var barcodePicker;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("isReady & onReady", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
ava_1.test.serial("onScan & removeScanListener & removeScanListeners", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
ava_1.test.serial("onSubmitFrame & removeSubmitFrameListener & removeSubmitFrameListeners", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var s, imageSettings, barcodePicker, callbackSpy1, callbackSpy2, callbackSpy3, scanResult;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
ava_1.test.serial("onScanError & removeScanErrorListener & removeScanErrorListeners", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                t.is(callbackSpy2.callCount, 0);
                t.is(callbackSpy3.callCount, 0);
                scanError = new scandit_sdk_1.CustomError({
...
ava_1.test.serial("onProcessFrame & removeProcessFrameListener & removeProcessFrameListeners", function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var s, imageSettings, barcodePicker, callbackSpy1, callbackSpy2, callbackSpy3, scanResult;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
