...
var _iterDefine = function(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if (BUGGY || VALUES_BUG || !proto[ITERATOR$3]) _hide(proto, ITERATOR$3, $default);
...
var BarcodePickerCameraManager = (function(_super) {
  ...
  BarcodePickerCameraManager.prototype.initializeCameraWithSettings = function(camera, cameraSettings) {
    ...
    return existingCameraInitializationPromise.then(function() {
      ...
      if (null != cameraSettings && cameraSettings.resolutionPreference === CameraSettings.ResolutionPreference.FULL_HD)
        ...
        if (null != event.target) {
          ...
          image_1.onprogress = function(event2) {
            if (event2.lengthComputable) {
              ...
              if (progress <= 100) _this.cameraUploadProgressElement.setAttribute("data-progress", progress.toString());
            }
          };
...
function engineSDKWorkerFunction() {
  ...
  function instantiateWebAssembly(importObject, wasmURI, successCallback, wasmRequest) {
    if (null == wasmRequest) wasmRequest = fetch(wasmURI);
    wasmRequest
  ...
  function instantiateWebAssemblyStreaming(importObject, wasmURI, successCallback) {
    var wasmRequest = fetch(wasmURI).catch(function() {
      return new Response();
    });
  ...
  function loadLibrary(deviceId, libraryLocation) {
    var customModule = {
      ...
      instantiateWasm: function instantiateWasm(importObject, successCallback) {
        var wasmURI = libraryLocation + "scandit-engine-sdk.wasm?v=4.0.0";
        var wasmVersion = "4.0.0"
          .split(".")
          .map(function(n, i) {
    ...
    if ("function" === typeof importScripts)
      try {
        importScripts(libraryLocation + "scandit-engine-sdk.min.js?v=4.0.0");
      } catch (error) {
        console.warn(error);
        console.error(
          "Couldn't retrieve Scandit SDK Engine library at " +
  ...
  function SymbologySettings(_a) {
    ...
    this.extensions = new Set(
      Array.from(extensions).filter(function(e) {
        return (
          e in SymbologySettings.Extension || -1 !== Object.values(SymbologySettings.Extension).indexOf(e.toLowerCase())
        );
      })
    );
...
var ScanSettings = (function() {
  ...
  ScanSettings.prototype.getSymbologySettings = function(symbology) {
    ...
    else if (symbology in Barcode.Symbology || -1 !== Object.values(Barcode.Symbology).indexOf(symbology)) {
    ...
    if ("object" === _typeof_1(symbology)) {
      try {
        for (
          ...
          if (!(s in Barcode.Symbology || -1 !== Object.values(Barcode.Symbology).indexOf(s)))
      ...
      try {
        for (
          ...
          else this.symbologySettings.set(s, new SymbologySettings({ enabled: enabled }));
        }
      } catch (e_2_1) {
        e_2 = { error: e_2_1 };
      } finally {
...
var ScannerEventEmitter = (function(_super) {
...
var BarcodePickerEventEmitter = (function(_super) {
...
var BarcodePicker = (function() {
  function BarcodePicker$$1(originElement, _a) {
  ...
  BarcodePicker$$1.create = function(originElement, _a) {
    var _b = void 0 === _a ? {} : _a,
      _c = _b.visible,
      ...
      _h = _b.guiStyle,
      guiStyle = void 0 === _h ? BarcodePicker$$1.GuiStyle.LASER : _h,
      _j = _b.videoFit,
      videoFit = void 0 === _j ? BarcodePicker$$1.ObjectFit.CONTAIN : _j,
      scanner = _b.scanner,
      _k = _b.scanSettings,
  ...
  BarcodePicker$$1.prototype.destroy = function(destroyScanner) {
  ...
  BarcodePicker$$1.prototype.applyScanSettings = function(scanSettings) {
    this.scanner.applyScanSettings(scanSettings);
    return this;
  };
  BarcodePicker$$1.prototype.isScanningPaused = function() {
    return this.scanningPaused;
  };
  BarcodePicker$$1.prototype.pauseScanning = function(pauseCamera) {
  ...
  BarcodePicker$$1.prototype.resumeScanning = function() {
    var _this = this;
    this.scanningPaused = false;
  ...
  BarcodePicker$$1.prototype.getActiveCamera = function() {
    return this.cameraManager.activeCamera;
  };
  BarcodePicker$$1.prototype.setActiveCamera = function(camera, cameraSettings) {
    var _this = this;
  ...
  BarcodePicker$$1.prototype.applyCameraSettings = function(cameraSettings) {
    var _this = this;
    if (!this.cameraAccess) {
      this.cameraManager.setSelectedCameraSettings(cameraSettings);
      return Promise.resolve(this);
  ...
  BarcodePicker$$1.prototype.isVisible = function() {
    return this.barcodePickerGui.isVisible();
  };
  BarcodePicker$$1.prototype.setVisible = function(visible) {
    this.barcodePickerGui.setVisible(visible);
    return this;
  };
  BarcodePicker$$1.prototype.isMirrorImageEnabled = function() {
    return this.barcodePickerGui.isMirrorImageEnabled();
  };
  BarcodePicker$$1.prototype.setMirrorImageEnabled = function(enabled) {
    this.barcodePickerGui.setMirrorImageEnabled(enabled, true);
    return this;
  };
  BarcodePicker$$1.prototype.isPlaySoundOnScanEnabled = function() {
    return this.playSoundOnScan;
  };
  BarcodePicker$$1.prototype.setPlaySoundOnScanEnabled = function(enabled) {
    this.playSoundOnScan = enabled;
    return this;
  };
  BarcodePicker$$1.prototype.isVibrateOnScanEnabled = function() {
    return this.vibrateOnScan;
  };
  BarcodePicker$$1.prototype.setVibrateOnScanEnabled = function(enabled) {
    this.vibrateOnScan = enabled;
    return this;
  };
  BarcodePicker$$1.prototype.isCameraSwitcherEnabled = function() {
    return this.cameraManager.isCameraSwitcherEnabled();
  };
  BarcodePicker$$1.prototype.setCameraSwitcherEnabled = function(enabled) {
    this.cameraManager.setCameraSwitcherEnabled(enabled);
    return this;
  };
  BarcodePicker$$1.prototype.isTorchToggleEnabled = function() {
    return this.cameraManager.isTorchToggleEnabled();
  };
  BarcodePicker$$1.prototype.setTorchToggleEnabled = function(enabled) {
    this.cameraManager.setTorchToggleEnabled(enabled);
    return this;
  };
  BarcodePicker$$1.prototype.isTapToFocusEnabled = function() {
    return this.cameraManager.isTapToFocusEnabled();
  };
  BarcodePicker$$1.prototype.setTapToFocusEnabled = function(enabled) {
    this.cameraManager.setTapToFocusEnabled(enabled);
    return this;
  };
  BarcodePicker$$1.prototype.isPinchToZoomEnabled = function() {
    return this.cameraManager.isPinchToZoomEnabled();
  };
  BarcodePicker$$1.prototype.setPinchToZoomEnabled = function(enabled) {
    this.cameraManager.setPinchToZoomEnabled(enabled);
    return this;
  };
  BarcodePicker$$1.prototype.setTorchEnabled = function(enabled) {
    this.cameraManager.setTorchEnabled(enabled);
    return this;
  };
  BarcodePicker$$1.prototype.setZoom = function(zoomPercentage) {
    this.cameraManager.setZoom(zoomPercentage);
    return this;
  };
  BarcodePicker$$1.prototype.isReady = function() {
    return this.isReadyToWork;
  };
  BarcodePicker$$1.prototype.onReady = function(listener) {
    if (this.isReadyToWork) listener();
    else this.eventEmitter.once("ready", listener, this);
    return this;
  };
  BarcodePicker$$1.prototype.onScan = function(listener, once) {
  ...
  BarcodePicker$$1.prototype.removeScanListener = function(listener) {
    this.eventEmitter.removeListener("scan", listener);
    return this;
  };
  BarcodePicker$$1.prototype.removeScanListeners = function() {
    this.eventEmitter.removeAllListeners("scan");
    return this;
  };
  BarcodePicker$$1.prototype.onScanError = function(listener, once) {
    if (void 0 === once) once = false;
    if (true === once) this.eventEmitter.once("scanError", listener, this);
    else this.eventEmitter.on("scanError", listener, this);
    return this;
  };
  BarcodePicker$$1.prototype.removeScanErrorListener = function(listener) {
    this.eventEmitter.removeListener("scanError", listener);
    return this;
  };
  BarcodePicker$$1.prototype.removeScanErrorListeners = function() {
    this.eventEmitter.removeAllListeners("scanError");
    return this;
  };
  BarcodePicker$$1.prototype.onSubmitFrame = function(listener, once) {
    if (void 0 === once) once = false;
    if (true === once) this.eventEmitter.once("submitFrame", listener, this);
    else this.eventEmitter.on("submitFrame", listener, this);
    return this;
  };
  BarcodePicker$$1.prototype.removeSubmitFrameListener = function(listener) {
    this.eventEmitter.removeListener("submitFrame", listener);
    return this;
  };
  BarcodePicker$$1.prototype.removeSubmitFrameListeners = function() {
    this.eventEmitter.removeAllListeners("submitFrame");
    return this;
  };
  BarcodePicker$$1.prototype.onProcessFrame = function(listener, once) {
    if (void 0 === once) once = false;
    if (true === once) this.eventEmitter.once("processFrame", listener, this);
    else this.eventEmitter.on("processFrame", listener, this);
    return this;
  };
  BarcodePicker$$1.prototype.removeProcessFrameListener = function(listener) {
    this.eventEmitter.removeListener("processFrame", listener);
    return this;
  };
  BarcodePicker$$1.prototype.removeProcessFrameListeners = function() {
    this.eventEmitter.removeAllListeners("processFrame");
    return this;
  };
  BarcodePicker$$1.prototype.setGuiStyle = function(guiStyle) {
    this.barcodePickerGui.setGuiStyle(guiStyle);
    return this;
  };
  BarcodePicker$$1.prototype.setVideoFit = function(objectFit) {
    this.barcodePickerGui.setVideoFit(objectFit);
    return this;
  };
  BarcodePicker$$1.prototype.accessCamera = function() {
    var _this = this;
  ...
  BarcodePicker$$1.prototype.createParserForFormat = function(dataFormat) {
    return this.scanner.createParserForFormat(dataFormat);
  };
  BarcodePicker$$1.prototype.reassignOriginElement = function(originElement) {
    this.barcodePickerGui.reassignOriginElement(originElement);
    return this;
  };
  BarcodePicker$$1.prototype.setTargetScanningFPS = function(targetScanningFPS) {
    if (targetScanningFPS > 0) this.targetScanningFPS = targetScanningFPS;
    return this;
  };
  BarcodePicker$$1.prototype.getScanner = function() {
    return this.scanner;
  };
  BarcodePicker$$1.prototype.triggerFatalError = function(error) {
    this.fatalError = error;
    console.error(error);
  };
  BarcodePicker$$1.prototype.handleScanResult = function(scanResult) {
  ...
  BarcodePicker$$1.prototype.scheduleVideoProcessing = function(timeout) {
    var _this = this;
  ...
  BarcodePicker$$1.prototype.scheduleNextVideoProcessing = function(processingStartTime) {
    if (this.targetScanningFPS < 30) {
      if (null == this.averageProcessingTime) this.averageProcessingTime = performance.now() - processingStartTime;
        ...
        this.averageProcessingTime = 0.9 * this.averageProcessingTime + 0.1 * (performance.now() - processingStartTime);
  ...
  BarcodePicker$$1.prototype.processVideoFrame = function(highQualitySingleFrameMode) {
    var _this = this;
  ...
  BarcodePicker$$1.prototype.videoProcessing = function() {
    var _this = this;
...
function configure(licenseKey, _a) {
  var _b = (void 0 === _a ? {} : _a).engineLocation,
    engineLocation = void 0 === _b ? "/" : _b;
  var browserCompatibility = BrowserHelper.checkBrowserCompatibility();
