...
A specific version of the library (example for 4.0.0) can also be included with:

```html
<script src="https://unpkg.com/scandit-sdk@4.0.0"></script>
<!-- or -->
<script src="https://cdn.jsdelivr.net/npm/scandit-sdk@4.0.0"></script>
```
