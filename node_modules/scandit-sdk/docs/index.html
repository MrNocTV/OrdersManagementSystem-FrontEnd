	...
	<div class="row">
		<div class="col-8 col-content">
			<div class="tsd-panel tsd-typography">
				<h1 id="scandit-barcode-scanner-sdk-for-the-web-omit-in-toc-">Scandit Barcode Scanner SDK for the Web<!-- omit in toc --></h1>
				...
				<pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/scandit-sdk"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-comment">&lt;!-- or --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/scandit-sdk"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></code></pre>
				<p>A specific version of the library (example for 4.0.0) can also be included with:</p>
				<pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/scandit-sdk@4.0.0"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-comment">&lt;!-- or --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/scandit-sdk@4.0.0"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></code></pre>
				...
				<pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"/node_modules/scandit-sdk/build/browser/index.min.js"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></code></pre>
				<p>Include as <a href="https://jakearchibald.com/2017/es-modules-in-browsers/">ES module</a>:</p>
				<pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"module"</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"/node_modules/scandit-sdk/build/browser/index.esm.min.js"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></code></pre>
...
barcodePicker.applyScanSettings(scanSettings);</code></pre>
				...
				<p>JavaScript:</p>
				<pre><code class="language-javascript">barcodePicker.onScan(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">scanResult</span>) </span>{
  alert(scanResult.barcodes.reduce(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">string, barcode</span>) </span>{
    <span class="hljs-keyword">return</span> string + ScanditSDK.Barcode.Symbology.toHumanizedName(barcode.symbology) + <span class="hljs-string">": "</span> + barcode.data + <span class="hljs-string">"\n"</span>;
				...
				<p>TypeScript:</p>
				<pre><code class="language-typescript">barcodePicker.onScan(<span class="hljs-function">(<span class="hljs-params">scanResult</span>) =&gt;</span> {
  alert(scanResult.barcodes.reduce(<span class="hljs-function">(<span class="hljs-params"><span class="hljs-built_in">string</span>, barcode</span>) =&gt;</span> {
    <span class="hljs-keyword">return</span> <span class="hljs-built_in">string</span> + <span class="hljs-string">`<span class="hljs-subst">${Barcode.Symbology.toHumanizedName(barcode.symbology)}</span>: <span class="hljs-subst">${barcode.data}</span>\n`</span>;
				...
				<h2 id="advanced-components-and-sample-apps">Advanced Components and Sample Apps</h2>
