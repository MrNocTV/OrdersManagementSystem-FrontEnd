					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-module"><a href="modules/barcode.html" class="tsd-kind-icon">Barcode</a></li>
								<li class="tsd-kind-module"><a href="modules/browsercompatibility.html" class="tsd-kind-icon">Browser<wbr>Compatibility</a></li>
								<li class="tsd-kind-module"><a href="modules/camera.html" class="tsd-kind-icon">Camera</a></li>
								<li class="tsd-kind-module"><a href="modules/cameraaccess.html" class="tsd-kind-icon">Camera<wbr>Access</a></li>
								<li class="tsd-kind-module"><a href="modules/camerasettings.html" class="tsd-kind-icon">Camera<wbr>Settings</a></li>
								<li class="tsd-kind-module"><a href="modules/imagesettings.html" class="tsd-kind-icon">Image<wbr>Settings</a></li>
							</ul>
						</section>
						<section class="tsd-index-section ">
							<h3>Classes</h3>
						...
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								...
								<li class="tsd-kind-interface"><a href="interfaces/scanresult.html" class="tsd-kind-icon">Scan<wbr>Result</a></li>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<div class="tsd-comment tsd-typography">
								...
								<p>Depending on parameters and device features, any of the following errors could be the rejected result of the returned
								promise:</p>
								<ul>
									<li><code>NoLicenseKeyError</code></li>
									<li><code>UnsupportedBrowserError</code></li>
								</ul>
								<p>Camera access requests and external Scandit Engine library loads are done lazily only when needed by a
									<a href="classes/barcodepicker.html">BarcodePicker</a> (or <a href="classes/scanner.html">Scanner</a>) object. To make the loading process faster when scanning is actually needed, it is
									recommended depending on the use case to create in advance a (hidden and paused) <a href="classes/barcodepicker.html">BarcodePicker</a> or <a href="classes/scanner.html">Scanner</a>
									object, to later simply show and unpause it when needed. You can also eagerly ask only for camera access permissions
								by calling the <a href="modules/cameraaccess.html#getcameras">CameraAccess.getCameras</a> function.</p>
							</div>
							...
							<p>A promise resolving when the library has been configured.</p>
						</li>
					</ul>
				</section>
			</section>
